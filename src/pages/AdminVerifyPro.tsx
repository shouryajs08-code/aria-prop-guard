      ...
      <div className="mx-auto max-w-lg space-y-6">
        ...
        <div className="rounded-lg border border-border bg-card p-6 space-y-3">
          ...
          <div className="space-y-2 font-body text-sm">
            ...
            <div className="flex justify-between"><span className="text-muted-foreground">isPro (computed)</span><span className={isPro ? 'text-safe' : 'text-danger'}>{isPro ? 'YES' : 'NO'}</span></div>
          </div>
        </div>
        ...
        <div className="rounded-lg border border-border bg-card p-6 space-y-3">
          ...
          <div className="space-y-2 font-body text-sm">
            ...
            <div className="flex justify-between"><span className="text-muted-foreground">Accounts Limit</span><span>{isPro ? '5' : '1'}</span></div>
          </div>
        </div>
