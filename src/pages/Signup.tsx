...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // With auto-confirm enabled, onAuthStateChange will fire and the useEffect above will redirect
  };
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#0A0A0A] px-6">
      <div className="w-full max-w-sm">
        ...
        <h1 className="font-display text-3xl font-light text-[#F5F2EE]">Start your free trial</h1>
        <p className="mt-2 font-body text-sm text-[#F5F2EE]/55">14 days free. No credit card required.</p>
        ...
        <div className="mt-8 space-y-5">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <Input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} required minLength={6} className="bg-[#1A1A1A] border-[#F5F2EE]/10 text-[#F5F2EE]" />
            </div>
